...
// dsmVersion combines major and minor version info into an int
// representation.
//
// Version 7.2 becomes 72 as an example.
func (t *target) dsmVersion() int {
...
func (t *target) dsmVersionString() string {
	...
	if t.dsmMinorVersion != 0 {
		dsmVersionString += fmt.Sprintf("-%d", t.dsmMinorVersion)
	}
...
func (t *target) buildSPK(b *dist.Build, inner *innerPkg) ([]string, error) {
	synoVersion := b.Version.Synology[t.dsmVersion()]
...
func (t *target) mkInfo(b *dist.Build, uncompressedSz int64) []byte {
	...
	f("package", "Tailscale")
	f("version", fmt.Sprintf("%s-%d", b.Version.Short, b.Version.Synology[t.dsmVersion()]))
